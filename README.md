...
5. Any SSD or HDD drive works. Samsung M.2 drives should work as well. Other M.2 drives will need a [patched IONVMeFamily.kext](https://github.com/koush/patch-nvme/blob/master/patch_nvme.sh#L29).
