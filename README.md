...
5. Any SSD or HDD drive works. Samsung M.2 drives should work as well. Will need to patch [SSDT-NVMe-Pcc.aml](https://github.com/koush/EFI-X99/blob/master/CLOVER/ACPI/patched/SSDT-NVMe-Pcc.aml) with the appropriate device path. See [guide](https://www.tonymacx86.com/threads/success-macos-10-12-2-ga-x99p-sli-intel-6950x-gtx-980ti-samsung-960-evo-nvme.209334/).
